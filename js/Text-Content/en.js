enContentJson = JSON.parse(`
{
	...
	"delay-message-videos-label"		: "Delay Message",
	"delay-message-videos-legend"		: "Delay message to be displayed when a command is used while in delay. Use {videoDelay} as a variable to be replaced by the number of seconds until next available use, and {videoCommand} as a variable for the command name.",
	"videos-title"						: "Videos",
	...
	"delay-message-sounds-label"		: "Delay Message",
	"delay-message-sounds-legend"		: "Delay message to be displayed when a command is used while in delay. Use {soundDelay} as a variable to be replaced by the number of seconds until next available use, and {soundCommand} as a variable for the command name.",
	"sounds-title"						: "Sounds",
